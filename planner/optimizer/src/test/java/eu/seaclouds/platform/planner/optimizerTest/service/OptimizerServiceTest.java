...
public class OptimizerServiceTest {
   ...
   private static final String BASE_URL = "http://localhost:8080/optimizer/optimizer/";
   ...
   public void createObjects() {
      ...
      log = LoggerFactory.getLogger(OptimizerServiceTest.class);
   ...
   public void testPresenceHeartbeat() {
      ...
      log.info("=== TEST for presence of OPTIMIZER service heartbeat ===");
      ...
      try {
         ...
         Assert.assertTrue(conn.getResponseCode() == 200,
               "Error requesting heartbeat. Instead of 200 we have received code " + conn.getResponseCode());
      ...
      log.info("=== TEST for presence of OPTIMIZER service heartbeat FINISHED ===");
